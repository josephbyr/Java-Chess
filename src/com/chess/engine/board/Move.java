...
public abstract class Move {
    ...
    public static class PieceAttackMove extends AttackMove {
        ...
        public PieceAttackMove(final Board board, final Piece pieceMoved, final int destinationCoordinate,
    ...
    public static class PawnJump extends Move {
        public PawnJump(final Board board, final Pawn movedPiece, final int destinationCoordinate) {
            super(board, movedPiece, destinationCoordinate);
        }
    ...
    static abstract class CastleMove extends Move {
        ...
        public CastleMove(final Board board, final Piece movedPiece, final int destinationCoordinate,
                final Rook castleRook, final int castleRookInitPos, final int castleRookDestPos) {
            super(board, movedPiece, destinationCoordinate);
